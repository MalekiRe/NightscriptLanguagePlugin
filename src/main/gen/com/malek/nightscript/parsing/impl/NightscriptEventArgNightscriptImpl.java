...
public class NightscriptEventArgNightscriptImpl extends ASTWrapperPsiElement implements NightscriptEventArg {

  public NightscriptEventArgNightscriptImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NightscriptVisitor visitor) {
    visitor.visitEventArg(this);
  }
