...
public class NightscriptEventLambdaFunctionNightscriptImpl extends ASTWrapperPsiElement implements NightscriptEventLambdaFunction {

  public NightscriptEventLambdaFunctionNightscriptImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NightscriptVisitor visitor) {
    visitor.visitEventLambdaFunction(this);
  }
  ...
  @Override
  @NotNull
  public PsiElement getEventlambda() {
