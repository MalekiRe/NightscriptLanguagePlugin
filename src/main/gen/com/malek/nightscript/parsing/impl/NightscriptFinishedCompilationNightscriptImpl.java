...
public class NightscriptFinishedCompilationNightscriptImpl extends ASTWrapperPsiElement implements NightscriptFinishedCompilation {

  public NightscriptFinishedCompilationNightscriptImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull NightscriptVisitor visitor) {
    visitor.visitFinishedCompilation(this);
  }
  ...
  public NightscriptMultiEvent getMultiEvent() {
    return findNotNullChildByClass(NightscriptMultiEvent.class);
  }
