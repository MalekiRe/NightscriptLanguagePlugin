...
public class NightscriptArgsNightscriptImpl extends ASTWrapperPsiElement implements NightscriptArgs {

  public NightscriptArgsNightscriptImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public NightscriptFunctionArg getFunctionArg() {
    return findNotNullChildByClass(NightscriptFunctionArg.class);
  }
